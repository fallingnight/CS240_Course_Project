...
$(1-1/e)$-approximate solution. This is our \textbf{primary paper for
reproduction}.
...
approximation and is directly applicable to distributed influence
maximization.
...
\textbf{Distributed extension goals:}
\begin{itemize}
...
Bichi Zhang & Algorithms & Greedy, CELF/CELF++, TIM/IMM implementation and analysis \\
Yaoqin Ye & Experiments & Datasets, evaluation, plots, and distributed extension \\
\bottomrule
\end{tabular}
